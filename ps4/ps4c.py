...
class SubMessage(object):
    ...
    def apply_transpose(self, transpose_dict):
        ...
        for i in self.message_text:
            encrypted_message += transpose_dict[i]
...
class EncryptedSubMessage(SubMessage):
    ...
    def decrypt_message(self):
        ...
        '''
         #get list of permutation possibilities
        vowel_permutations = get_permutations('aeiou')
        return_message = [0, self.message_text]
        ...
        for perm in vowel_permutations:
            ...
            list_of_words = encrypted_message.split()
            ...
            if valid_word_count > return_message[0]:
                return_message[0] = valid_word_count
                return_message[1] = encrypted_message
...
if __name__ == '__main__':
    ...
    # Example test case
    message = SubMessage("What is up you greasy little monkey fucks.")
    permutation = "eaiuo"
